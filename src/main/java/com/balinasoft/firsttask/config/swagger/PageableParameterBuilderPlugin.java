...
public class PageableParameterBuilderPlugin implements ParameterBuilderPlugin {
    ...
    public void apply(ParameterContext context) {
        ...
        if (type != null && Pageable.class.isAssignableFrom(type)) {
            ...
            ArrayList<Parameter> parameterList = newArrayList(
            ...
            if (parameter.getParameterAnnotation(WithoutSort.class) == null) {
                parameterList.add(
                        context.parameterBuilder()
            ...
            context.getOperationContext().operationBuilder().parameters(parameterList);
        }
    }
